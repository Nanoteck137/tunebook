...
func (s *UserService) GetAllUserYearReviews(
	...
	res, err := s.db.GetUserYearReviews(
		ctx,
		database.GetUserYearReviewsParams{
			UserId: params.UserId,
		},
	)
	if err != nil {
...
func (s *UserService) GetUserYearReview(
	...
	review, err := s.db.GetUserYearReview(
		ctx,
		database.GetUserYearReviewParams{
			UserId: params.UserId,
			Year:   params.Year,
		},
	)
...
func (s *UserService) GetUserYearReviewTracks(
	...
	if err != nil {
		...
		return nil, types.Page{}, 
			userErr.Wrap("get user year review tracks: user", err)
	}
...
func (s *UserService) GetUserYearReviewTags(
	...
	if err != nil {
		...
		return nil, types.Page{}, 
			userErr.Wrap("get user year review tags: user", err)
	}
...
func (s *UserService) GetUserYearReviewDecades(
	...
	if err != nil {
		...
		return nil, types.Page{}, 
			userErr.Wrap("get user year review decades: user", err)
	}
...
func (s *UserService) GenerateUserReview(
	...
	err = s.db.GenerateUserReview(ctx, database.GenerateUserReviewParams{
		UserId: params.UserId,
		Year:   params.Year,
	})
	if err != nil {

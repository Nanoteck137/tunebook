...
export class ApiClient extends BaseApiClient {
  ...
  addAlbumToQueue(queueId: string, albumId: string, body: api.AddAlbumToQueueBody, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/add/albums/${albumId}`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  addArtistToQueue(queueId: string, artistId: string, body: api.AddArtistToQueueBody, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/add/artists/${artistId}`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  addFavoritesToQueue(queueId: string, userId: string, body: api.AddFavoritesToQueueBody, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/add/favorites/${userId}`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  addItemToPlaylist(playlistId: string, body: api.AddItemToPlaylistBody, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}/items`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  addPlaylistToQueue(queueId: string, playlistId: string, body: api.AddPlaylistToQueueBody, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/add/playlists/${playlistId}`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  addTracksToQueue(queueId: string, body: api.AddTracksToQueueBody, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/add/tracks`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  
  authClaimQuickConnectCode(body: api.AuthClaimQuickConnectCodeBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/quick-connect/claim", "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  authFinishProvider(body: api.AuthFinishProviderBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/providers/finish", "POST", api.AuthFinishProvider, z.any().optional(), body, options)
  }
  
  authFinishQuickConnect(body: api.AuthFinishQuickConnectBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/quick-connect/finish", "POST", api.AuthFinishQuickConnect, z.any().optional(), body, options)
  }
  
  authGetProviderStatus(body: api.AuthGetProviderStatusBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/provider/status", "POST", api.AuthGetProviderStatus, z.any().optional(), body, options)
  }
  
  authGetProviders(options?: ExtraOptions) {
    return this.request("/api/v1/auth/providers", "GET", api.GetAuthProviders, z.any().optional(), undefined, options)
  }
  
  authGetQuickConnectStatus(body: api.AuthGetQuickConnectStatusBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/quick-connect/status", "POST", api.AuthGetQuickConnectStatus, z.any().optional(), body, options)
  }
  
  authProviderInitiate(body: api.AuthInitiateBody, options?: ExtraOptions) {
    return this.request("/api/v1/auth/providers/initiate", "POST", api.AuthInitiate, z.any().optional(), body, options)
  }
  
  authQuickConnectInitiate(options?: ExtraOptions) {
    return this.request("/api/v1/auth/quick-connect/initiate", "POST", api.AuthQuickConnectInitiate, z.any().optional(), undefined, options)
  }
  
  clearQueue(queueId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  createApiToken(body: api.CreateApiTokenBody, options?: ExtraOptions) {
    return this.request("/api/v1/me/apitokens", "POST", api.CreateApiToken, z.any().optional(), body, options)
  }
  
  createPlaylist(body: api.CreatePlaylistBody, options?: ExtraOptions) {
    return this.request("/api/v1/playlists", "POST", api.CreatePlaylist, z.any().optional(), body, options)
  }
  
  createSseToken(options?: ExtraOptions) {
    return this.request("/api/v1/system/sse/token", "POST", api.CreateSSEToken, z.any().optional(), undefined, options)
  }
  
  createTrackFilter(body: api.CreateTrackFilterBody, options?: ExtraOptions) {
    return this.request("/api/v1/filters/tracks", "POST", api.CreateTrackFilter, z.any().optional(), body, options)
  }
  
  deleteApiToken(tokenId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/me/apitokens/${tokenId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  deletePlaylist(playlistId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  deleteTrackFilter(filterId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/filters/tracks/${filterId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  editPlaylist(playlistId: string, body: api.EditPlaylistBody, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}`, "PATCH", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  favoriteTrack(trackId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/favorites/tracks/${trackId}`, "POST", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  ...
  getAlbumTracks(id: string, options?: ExtraOptions) {
    return this.request(`/api/v1/albums/${id}/tracks`, "GET", api.GetAlbumTracks, z.any().optional(), undefined, options)
  }
  ...
  getApiTokens(options?: ExtraOptions) {
    return this.request("/api/v1/me/apitokens", "GET", api.GetApiTokens, z.any().optional(), undefined, options)
  }
  
  getArtistAlbums(id: string, options?: ExtraOptions) {
    return this.request(`/api/v1/artists/${id}/albums`, "GET", api.GetArtistAlbumsById, z.any().optional(), undefined, options)
  }
  
  getArtistById(id: string, options?: ExtraOptions) {
    return this.request(`/api/v1/artists/${id}`, "GET", api.GetArtistById, z.any().optional(), undefined, options)
  }
  
  
  getArtists(options?: ExtraOptions) {
    return this.request("/api/v1/artists", "GET", api.GetArtists, z.any().optional(), undefined, options)
  }
  ...
  getMediaSettings(options?: ExtraOptions) {
    return this.request("/api/v1/media/settings", "GET", api.GetMediaSettings, z.any().optional(), undefined, options)
  }
  
  getPlaylistById(playlistId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}`, "GET", api.GetPlaylistById, z.any().optional(), undefined, options)
  }
  
  
  getPlaylistItemIds(playlistId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}/ids`, "GET", api.GetPlaylistItemIds, z.any().optional(), undefined, options)
  }
  
  getPlaylistItems(playlistId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}/items`, "GET", api.GetPlaylistItems, z.any().optional(), undefined, options)
  }
  
  getPlaylists(options?: ExtraOptions) {
    return this.request("/api/v1/playlists", "GET", api.GetPlaylists, z.any().optional(), undefined, options)
  }
  
  getQueue(queueId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}`, "GET", api.GetQueue, z.any().optional(), undefined, options)
  }
  
  getQueueIds(queueId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/ids`, "GET", api.GetQueueIds, z.any().optional(), undefined, options)
  }
  
  getQueueItemAtIndex(queueId: string, position: string, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/items/${position}`, "GET", api.GetQueueItem, z.any().optional(), undefined, options)
  }
  ...
  getTrackById(id: string, options?: ExtraOptions) {
    return this.request(`/api/v1/tracks/${id}`, "GET", api.GetTrackById, z.any().optional(), undefined, options)
  }
  
  getTrackFilters(options?: ExtraOptions) {
    return this.request("/api/v1/filters/tracks", "GET", api.GetTrackFilters, z.any().optional(), undefined, options)
  }
  
  getTrackHistory(options?: ExtraOptions) {
    return this.request("/api/v1/history/tracks", "GET", api.GetTrackHistory, z.any().optional(), undefined, options)
  }
  
  getTrackHistoryById(id: string, options?: ExtraOptions) {
    return this.request(`/api/v1/history/tracks/${id}`, "GET", api.GetHistoryById, z.any().optional(), undefined, options)
  }
  
  getTracks(options?: ExtraOptions) {
    return this.request("/api/v1/tracks", "GET", api.GetTracks, z.any().optional(), undefined, options)
  }
  
  getUser(userId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/users/${userId}`, "GET", api.GetUser, z.any().optional(), undefined, options)
  }
  
  
  getUserStats(userId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/users/${userId}/stats`, "GET", api.GetUserStats, z.any().optional(), undefined, options)
  }
  ...
  getUserYearReviewTags(userId: string, year: string, options?: ExtraOptions) {
    return this.request(`/api/v1/users/${userId}/year-reviews/${year}/tags`, "GET", api.GetUserYearReviewTags, z.any().optional(), undefined, options)
  }
  ...
  pushTrackHistory(body: api.PushTrackHistoryBody, options?: ExtraOptions) {
    return this.request("/api/v1/history/tracks", "POST", api.PushTrackHistory, z.any().optional(), body, options)
  }
  
  removePlaylistItem(playlistId: string, body: api.RemovePlaylistItemBody, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}/items`, "DELETE", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  removeQueueItem(queueId: string, itemId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/queues/${queueId}/items/${itemId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  reorderPlaylistItems(playlistId: string, body: api.ReorderPlaylistItemsBody, options?: ExtraOptions) {
    return this.request(`/api/v1/playlists/${playlistId}/items/reorder`, "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  reorderPlaylists(body: api.ReorderPlaylistsBody, options?: ExtraOptions) {
  ...
  searchAlbums(options?: ExtraOptions) {
    return this.request("/api/v1/search/albums", "GET", api.SearchAlbums, z.any().optional(), undefined, options)
  }
  
  searchArtists(options?: ExtraOptions) {
    return this.request("/api/v1/search/artists", "GET", api.SearchArtists, z.any().optional(), undefined, options)
  }
  
  searchPlaylists(options?: ExtraOptions) {
    return this.request("/api/v1/search/playlists", "GET", api.SearchPlaylists, z.any().optional(), undefined, options)
  }
  
  searchTracks(options?: ExtraOptions) {
    return this.request("/api/v1/search/tracks", "GET", api.SearchTracks, z.any().optional(), undefined, options)
  }
  ...
  setQuickPlaylist(body: api.SetQuickPlaylistBody, options?: ExtraOptions) {
    return this.request("/api/v1/me/quickplaylist", "POST", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  
  
  unfavoriteTrack(trackId: string, options?: ExtraOptions) {
    return this.request(`/api/v1/favorites/tracks/${trackId}`, "DELETE", z.undefined().optional(), z.any().optional(), undefined, options)
  }
  
  updateMe(body: api.UpdateMeBody, options?: ExtraOptions) {
    return this.request("/api/v1/me", "PATCH", z.undefined().optional(), z.any().optional(), body, options)
  }
  
  updateTrackFilter(filterId: string, body: api.UpdateTrackFilterBody, options?: ExtraOptions) {
    return this.request(`/api/v1/filters/tracks/${filterId}`, "PATCH", z.undefined().optional(), z.any().optional(), body, options)
  }
...
export class ClientUrls {
  ...
  getUserYearReviewTags(userId: string, year: string) {
    return createUrl(this.baseUrl, `/api/v1/users/${userId}/year-reviews/${year}/tags`)
  }
  
  getUserYearReviewTracks(userId: string, year: string) {
    return createUrl(this.baseUrl, `/api/v1/users/${userId}/year-reviews/${year}/tracks`)
  }

...
>
	...
	{#if showTooltip}
		<div
			class="pointer-events-none absolute -top-8 z-10 rounded-md bg-foreground px-2 py-1 text-xs font-medium text-background shadow-md"
			style="left: {displayValue * 100}%; transform: translateX(-50%)"
		>
	...
	<!-- Buffered fill -->
	<div
		class="pointer-events-none absolute top-1/2 left-0 h-1 -translate-y-1/2 rounded-full bg-muted-foreground/20"
